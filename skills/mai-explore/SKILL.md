...
Navigation intent: choose layout, impact or decisions for the bounded exploration question. Use candidate links to guide the source trace; the trace remains required.
